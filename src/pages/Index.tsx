...
const Index = () => {
  ...
  return <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      <div className="text-center space-y-6 p-8 max-w-4xl">
        ...
        <p className="text-xl text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">Helder inzicht. Sprankelend resultaat.</p>
        <div className="flex gap-4 justify-center mt-8">
          <Button size="lg" onClick={() => navigate('/auth')} className="bg-gradient-to-r from-blue-600 to-teal-600 hover:from-blue-700 hover:to-teal-700">
            Login
          </Button>
